...
<head>
    ...
    <!-- <link href="./usercss/emranStyle.css" rel="stylesheet" /> -->
        ...
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarCollapse">
                    ...
                    <form class="d-flex"><a href="./userPages/signin.html"><i class="fa-solid fa-arrow-right-to-bracket"> Login</i></a>
                        <form class="d-flex"><a href="./userPages/cart.html"><i class="fa-solid fa-cart-shopping"></i></a>
                        </form>
                </div>
            </div>
        </nav>
            ...
            <div class="row">
                ...
                <div class="col-9">
                    <div class="row row-cols-1 row-cols-md-3 g-4">
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/bramleyApple.jpg" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Bramley</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a
                                        natural lead-in to additional content. This content is a
                                        little bit longer.
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/redDeliciousApple.jpg" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Red Delicious</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a
                                        natural lead-in to additional content. This content is a
                                        little bit longer.
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/goldenDeliciousApple.jpg" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Golden Delicious</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/coxApple.jpg" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Cox</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a
                                        natural lead-in to additional content.
                                    </p>
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/braeburnApple.png" class="card-img-top" alt="..." />
                                <div class="card-body">
                                    <h5 class="card-title">Braeburn</h5>
                                    <p class="card-text">
                                        This is a longer card with supporting text below as a
                                        natural lead-in to additional content.
                                    </p>
                        ...
                        <div class="col">
                            <div class="card">
                                <img src="../img/royalGalaApple.jpeg" class="card-img-top" alt="..." />
                                <div class="card-body">
