        ...
        <table class=" table table-success table-striped table-hover text-center">
            ...
            <tbody>
                <tr>
                    ...
                    <td>10</td>
                    <td>
                        <a href="./viewCategory.php" class="link-success"><i class="fa-solid fa-eye fs-5 me-3"></i></a>
                        <a href="./editCategory.php" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
