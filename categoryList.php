...
<body>
    ...
    <div class="container ">
        <div class=" justify-content-center fs-5 mb-3">
            <a href="./addCategory.php" class="btn btn-success" type="submit">Add Category</a>
        </div>
        <?php
            ...
            <tbody>
                <?php foreach ($categoryInfo as $key => $user) { ?>
                    <tr>
                        ...
                        <td><?= $user['products'] ?></td>
                        <td>
                            <a href="viewCategory.php?id=<?php echo $user['id'] ?>" class="link-success"><i class="fa-solid fa-eye fs-5 me-3"></i></a>
                            <a href="editCategory.php?id=<?php echo $user['id'] ?>" class="link-info"><i class="fa-solid fa-pen-to-square fs-5 me-3"></i></a>
                            <a href="deleteCategory.php?id=<?php echo $user['id'] ?>" class="link-danger"><i class="fa-solid fa-trash fs-5"></i></a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
